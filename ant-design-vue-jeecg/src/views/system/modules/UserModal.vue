  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="密级标识" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select v-model="model.classificationLevel" placeholder="请选择密级" :getPopupContainer="(target) => target.parentNode">
