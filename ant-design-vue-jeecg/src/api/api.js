...
export default {
  addRole,editRole,checkRoleCode,queryall,
  addUser,editUser,queryUserRole,getUserList,
  frozenBatch,checkOnlyUser,changePassword,
  getPermissionList,addPermission,editPermission,queryTreeList,queryListAsync,queryRolePermission,saveRolePermission,
  queryPermissionsByUser,loadAllRoleIds,getPermissionRuleList,queryPermissionRule,
  queryDepartTreeList,queryDepartTreeSync,queryIdTree,queryParentName,searchByKeywords,deleteByDepartId,
  deleteLog,deleteLogList,addDict,editDict,treeList,addDictItem,editDictItem,doReleaseData,doReovkeData,
  getLoginfo,getVisitInfo,queryUserByDepId,duplicateCheck,
  queryTreeListForRole,getSystemMenuList,getSystemSubmenu,getSystemSubmenuBatch,
  loadCategoryData,checkRuleByCode,
  queryDepartPermission,saveDepartPermission,
  queryTreeListForDeptRole,queryDeptRolePermission,saveDeptRolePermission,
  queryMyDepartTreeList,getUserNoticeInfo,getDictItemsFromCache,
  minioFolderList,minioFolderAdd,minioFolderEdit,minioFolderDelete,
  minioFolderDeleteBatch,minioFolderQueryById,
  minioFileList,minioFileQueryById,minioFileEdit,minioFileDelete,
  minioFileDownload,minioFileCountByType,minioFileTagStats,
